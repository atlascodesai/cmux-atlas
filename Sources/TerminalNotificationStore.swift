...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "\(Branding.releaseBundleIdentifier).userNotification"
    static let actionShowIdentifier = "\(Branding.releaseBundleIdentifier).userNotification.show"
